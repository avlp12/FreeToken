...
"fail loudly" paths (no vision support; placeholder-slot vs embedding-row mismatch)
produce a clean per-request ErrorReplyMsg instead of a crash or a silently wrong answer.
...
real Qwen3.8-Flash-Next-NVFP4 checkpoint's image preprocessing (freetoken.models.qwen4_exp.
...
# --------------------------------------------------------------------------------------
# _fill_mm_embeds, called directly (unbound)
# --------------------------------------------------------------------------------------
